...
set_input_delay -clock [get_clocks GMII_RX_CLK_IN] -min 0.000 [get_ports GMII_RXD_IN*]
set_input_delay -clock [get_clocks GMII_RX_CLK_IN] -min 0.000 [get_ports GMII_RX_ER_IN]
set_input_delay -clock [get_clocks GMII_RX_CLK_IN] -min 0.000 [get_ports GMII_RX_DV_IN]
set_input_delay -clock [get_clocks GMII_RX_CLK_IN] -max 6.000 [get_ports GMII_RXD_IN*]
set_input_delay -clock [get_clocks GMII_RX_CLK_IN] -max 6.000 [get_ports GMII_RX_ER_IN]
set_input_delay -clock [get_clocks GMII_RX_CLK_IN] -max 6.000 [get_ports GMII_RX_DV_IN]
...
set_output_delay -clock GMII_TX_CLK_IN -max 15.000 [get_ports GMII_TXD_OUT*]
set_output_delay -clock GMII_TX_CLK_IN -min 0.000 [get_ports GMII_TXD_OUT*]
set_output_delay -clock GMII_TX_CLK_IN -max 15.000 [get_ports GMII_TX_EN_OUT]
set_output_delay -clock GMII_TX_CLK_IN -min 0.000 [get_ports GMII_TX_EN_OUT]
set_output_delay -clock GMII_TX_CLK_IN -max 15.000 [get_ports GMII_TX_ER_OUT]
set_output_delay -clock GMII_TX_CLK_IN -min 0.000 [get_ports GMII_TX_ER_OUT]
...
set_max_delay -from [get_ports GMII_MDIO_IO] 5.000
set_min_delay -from [get_ports GMII_MDIO_IO] -5.000
set_max_delay -from [get_ports I2C_SDA_IO] 5.000
set_min_delay -from [get_ports I2C_SDA_IO] -5.000
set_max_delay -from [get_ports GPIO_DIP_SW_IN*] 10.000
set_min_delay -from [get_ports GPIO_DIP_SW_IN*] 0.000
set_max_delay -from [get_ports SW_N_IN] 10.000
set_min_delay -from [get_ports SW_N_IN] 0.000
...
set_property PACKAGE_PIN Y23 [get_ports IN1]
set_property PACKAGE_PIN K25 [get_ports IN3]
set_property IOSTANDARD LVCMOS25 [get_ports IN1]
set_property IOSTANDARD LVCMOS25 [get_ports IN2]
set_property IOSTANDARD LVCMOS25 [get_ports IN3]
set_property PACKAGE_PIN D17 [get_ports IN4_p]
set_property PACKAGE_PIN AG29 [get_ports IN5_p]
set_property IOSTANDARD LVDS_25 [get_ports IN4_p]
set_property IOSTANDARD LVDS_25 [get_ports IN4_n]
set_property IOSTANDARD LVDS_25 [get_ports IN5_p]
set_property IOSTANDARD LVDS_25 [get_ports IN5_n]

set_property OFFCHIP_TERM NONE [get_ports OUT2]
set_property PACKAGE_PIN Y24 [get_ports OUT2]
set_property IOSTANDARD LVCMOS25 [get_ports OUT2]
set_property DRIVE 12 [get_ports OUT2]


set_property PACKAGE_PIN Y24 [get_ports IN2]

set_property PACKAGE_PIN L25 [get_ports IN6]
set_property IOSTANDARD LVCMOS25 [get_ports IN6]
